...
class DSL_Pipeline_PAR:
    ...
    def run(self) -> bool:
        global has_error,input_srcs_bk 
        ...
        while True:
            ...
            # New Secondary GIE
            retval = dsl_infer_gie_secondary_new(
                "secondary-gie",
            ...
            retval = dsl_osd_pph_add(
                "on-screen-display", handler="custom-pph-par", pad=DSL_PAD_SINK
            )
            if retval != DSL_RETURN_SUCCESS:
                break
