...
class DSL_TritonPipeline:
    def __init__(
        ...
        """
        global cams_bk, input_srcs_bk, g_pipeline_name, g_custom_pph_name
    ...
    def run(self) -> bool:
        global has_error,input_srcs_bk,g_pipeline_name,g_custom_pph_name
